class CoinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coin.save
        format.html { redirect_to @coin, notice: "#{t('coin_was_successfully_created')}." }
  ...
  def update
    respond_to do |format|
      if @coin.update(coin_params)
        format.html { redirect_to @coin, notice: "#{t('coin_was_successfully_updated')}." }
  ...
  def destroy
    @coin.destroy
    respond_to do |format|
      format.html { redirect_to coins_url, notice: "#{t('coin_was_successfully_destroyed')}." }
