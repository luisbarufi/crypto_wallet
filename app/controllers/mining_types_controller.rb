class MiningTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mining_type.save
        format.html { redirect_to @mining_type, notice: "#{t('mining_type_was_successfully_created')}." }
  ...
  def update
    respond_to do |format|
      if @mining_type.update(mining_type_params)
        format.html { redirect_to @mining_type, notice: "#{t('mining_type_was_successfully_updated')}." }
  ...
  def destroy
    @mining_type.destroy
    respond_to do |format|
      format.html { redirect_to mining_types_url, notice: "#{t('mining_type_was_successfully_destroyed')}." }
